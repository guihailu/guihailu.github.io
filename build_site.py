...
css = """
:root{--deep:#0b1424;--deep2:#101d36;--gold:#c9a45c;--gold2:#e6c886;--paper:#f6f0e0;--paper2:#efe5cc;--paper3:#e8dcc0;--ink:#2c2518;--ink2:#6f6248;--cin:#b03a2e;--line:#d9caa5;--shadow:rgba(11,20,36,.25);}
...
.paper{background:var(--paper);background-image:radial-gradient(rgba(180,160,120,.06) 1px,transparent 1px);background-size:22px 22px;border-radius:18px 18px 0 0;margin-top:-56px;position:relative;z-index:1;box-shadow:0 -6px 30px rgba(0,0,0,.25);}
...
.wrap blockquote{margin:20px 0;padding:14px 22px;background:var(--paper2);border-left:4px solid var(--cin);border-radius:0 10px 10px 0;color:#4a3f2a;box-shadow:0 1px 6px rgba(140,120,80,.10);}
.wrap blockquote p{margin:7px 0;}
.wrap ul,.wrap ol{padding-left:28px;}
.wrap li{margin:8px 0;}
.wrap a{color:#8a4a3c;text-decoration:none;border-bottom:1px dashed var(--cin);}
...
.wrap th{background:var(--paper3);color:#7c3a22;}
